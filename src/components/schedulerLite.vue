<template>
    <div class="schedule" @dragover="disableDragendAnimation">
      <div>
          ...
          <div class="sc-rows-scroll" :style="{ width: '100%' }">
            <div
              ...
              :style="{
                ...
                'padding-top': index == 0 ? state.padding - 4 + 'px' : '0px',
                'padding-bottom': index == 0 ? state.padding + 1 + 'px' : '0px',
              }"
        ...
        <div
          class="sc-main-box"
          :style="{ width: 98 - state.settingData.titleDivW + '%' }" 
        >
          <div class="sc-main-scroll" :style="{
             width: state.contentW + '%',
             }">   
            <div class="sc-main">
                <div
                    class="timeline"
  ...
  export default defineComponent({
    ...
    setup(props, { emit }) {
      ...
      const updateStateSetting = async () => {
        state.settingData = setting.value
      ...
      onMounted(updateStateSetting)

      watch(setting, updateStateSetting)
      ...
      const selectStartTime = (rowIndex, keyIndex) => {
        ...
        let msg = prompt(`Пожалуйста, задайте значение:\n + ${new Date(state.settingData.startDate)} `, "0"); //
        if (msg == null || msg == "") {
             return null; 
        } else {
            textMsg = msg;
  ...
  .notMe {
    background-color: #62b2be; /* !important; */
  }
