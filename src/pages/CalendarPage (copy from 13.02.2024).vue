  ...
  <div :class="$style.calendarpage">
   ...
   <div :class="$style.calendarpageChild"/>
    ...
    <div class="card">
                  ...
                  <div :class="$style.buttonSynchronization">
                    <Button type="button" label="⇆" icon="pi pi-database" style="margin-right: 0.4rem; height:35px; width:50px; backgroundColor: var(--primary-color); color: var(--primary-color-text)" @click="loadLazyData()"/>
                  </div>
  ...
  export default defineComponent({
    ...
    addNewRow() {
      ...
      loadLazyData() {
        ...
        dayEndDate = new Date(this.datePicerValues.endDate).getDate() 
