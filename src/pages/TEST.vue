...
<!-- 
    ...
    <div class="card">
        ...
        <DataTable 
            ...
            <Column field="hotelCity" header="Город" style="min-width: 100px; width: 2%; padding: 1rem" alignFrozen="left" :frozen="cityFrozen" ></Column>
            <Column field="hotelStars" header="Звезд" style="min-width: 1rem; padding: 1rem"></Column>
