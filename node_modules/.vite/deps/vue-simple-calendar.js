...
var Ye = (e, r, a) => r in e ? Te(e, r, { enumerable: true, configurable: true, writable: true, value: a }) : e[r] = a;
var Y = (e, r, a) => (Ye(e, typeof r != "symbol" ? r + "" : r, a), a);
var H = () => U(/* @__PURE__ */ new Date());
var We = (e, r, a) => {
  switch (r) {
    case "year":
...
var He = (e) => [...Array(7)].map((r, a) => L(e, a));
var L = (e, r) => new Date(e.getFullYear(), e.getMonth(), e.getDate() + r, e.getHours(), e.getMinutes(), e.getSeconds());
var J = (e, r) => L(e, (r - e.getDay() - 7) % -7);
var Ne = (e, r) => L(J(e, r), 7);
var W = (e) => new Date(e.getFullYear(), e.getMonth());
var Be = (e) => Math.ceil(e.getDate() / 7);
var Ee = (e, r, a) => new Date(e.getFullYear() + (r == "year" ? a : 0), e.getMonth() + (r == "month" ? a : 0), e.getDate() + (r == "week" ? a * 7 : 0));
var K = (e) => ("0" + String(e.getMonth() + 1)).slice(-2);
var X = (e) => ("0" + String(e.getDate())).slice(-2);
var ue = (e) => e.getFullYear() + "-" + K(e);
var Ue = (e) => ue(e) + "-" + X(e);
var Re = (e) => K(e) + "-" + X(e);
var Ve = (e, r, a) => {
...
var je = (e, r) => !!e && !!r && ce(e, r) === 0;
var qe = (e, r) => !!e && !!r && e.getTime() === r.getTime();
var ge = (e, r) => !!e && !!r && e.getFullYear() === r.getFullYear() && e.getMonth() === r.getMonth();
var Ge = (e) => W(e) < W(H());
var Qe = (e) => W(e) > W(H());
var Je = (e) => U(e) > H();
var Ke = (e) => U(e) < H();
var Xe = (e) => e.getMonth() !== L(e, 7).getMonth();
var Ze = (e) => e.getMonth() !== L(e, 1).getMonth();
var me = (e) => {
  let r = [...Array(7)].map((a) => 0);
  return e.split(/\D/, 7).forEach((a, d) => r[d] = Number(a)), r[1]--, new Date(r[0], r[1], r[2], r[3], r[4], r[5], r[6]);
};
var Q = (e) => typeof e == "string" ? me(e) : new Date(e);
var U = (e) => {
  const r = new Date(e);
  return r.setHours(0, 0, 0, 0), r;
};
var xe = (e) => e.substring(0, 2);
var R = () => typeof Intl < "u";
var _e = (e, r) => {
  if (!R())
...
var tt = () => typeof navigator > "u" ? "unk" : (navigator.languages && navigator.languages.length ? navigator.languages[0] : navigator.language).toLowerCase();
var at = (e, r) => {
...
var nt = { class: "cv-header-days" };
var st = {
  key: 0,
  class: "cv-weeknumber"
};
var ot = ["aria-multiselectable"];
var it = {
  key: 0,
  class: "cv-weeknumber"
};
var lt = { class: "cv-weekdays" };
var dt = ["draggable", "aria-grabbed", "aria-label", "aria-selected", "aria-dropeffect", "onClick", "onDragstart", "onDrop", "onDragover", "onDragenter", "onDragleave"];
var ut = { class: "cv-day-number" };
var ct = ["draggable", "aria-grabbed", "title", "onDragstart", "onMouseenter", "onMouseleave", "onClick", "innerHTML"];
var gt = ["draggable", "aria-grabbed", "title", "onDragstart", "onMouseenter", "onMouseleave", "onClick"];
var Mt = defineComponent({
  ...
  setup(e, { emit: r }) {
    const a = e, d = r, u = reactive(new rt()), c = computed(() => a.locale || n.getDefaultBrowserLocale()), I = computed(() => a.showDate ? n.dateOnly(a.showDate) : n.today()), p = computed(() => n.beginningOfPeriod(I.value, a.displayPeriodUom, a.startingDayOfWeek)), M = computed(
    ...
    }), N = computed(() => n.beginningOfWeek(p.value, a.startingDayOfWeek)), V = computed(() => n.endOfWeek(M.value, a.startingDayOfWeek)), fe = computed(() => {
      const t = Math.floor((n.dayDiff(N.value, V.value) + 1) / 7);
      return [...Array(t)].map((o, i) => n.addDays(N.value, i * 7));
    }), z = computed(() => n.getFormattedMonthNames(c.value, a.monthNameFormat)), De = computed(() => n.getFormattedWeekdayNames(c.value, a.weekdayNameFormat, a.startingDayOfWeek)), j = computed(() => a.items ? a.items.map((t) => n.normalizeItem(t, t.id === u.currentHoveredItemId)) : []), q = computed(() => n.beginningOfPeriod(n.today(), a.displayPeriodUom, a.startingDayOfWeek)), pe = computed(
      () => n.addDays(n.incrementPeriod(q.value, a.displayPeriodUom, a.displayPeriodCount), -1)
    ), ve = computed(() => n.formattedPeriod(p.value, M.value, a.displayPeriodUom, z.value)), he = computed(() => {
    ...
    const Pe = (t, o) => {
      ...
      let i = new Image();
      return i.src = "data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACH5BAEAAAAALAAAAAABAAEAAAICRAEAOw==", (s = o.dataTransfer) == null || s.setDragImage(i, 10, 10), u.dateSelectionOrigin = t, d("date-selection-start", G(t), o), true;
    }, ee = (t, o) => {
      var i;
      return a.enableDragDrop ? ((i = o.dataTransfer) == null || i.setData("text", t.id), u.currentDragItem = t, u.dateSelectionOrigin = void 0, d("drag-start", t, o), true) : false;
      ...
      for (let s = 0; s < o.length; s++) {
        ...
        for (let C = 0; C < 7; C++)
          if (C === T) {
            ...
            for (; m[C][E]; )
              E++;
            l.itemRow = E, m[C][E] = true;
          } else
            C < T + se && (m[C][l.itemRow] = true);
    ...
    return (t, o) => (openBlock(), createElementBlock("div", {
      ...
      class: normalizeClass([
        "cv-wrapper",
        `locale-${unref(n).languageCode(c.value)}`,
        `locale-${c.value}`,
        `y${p.value.getFullYear()}`,
        `m${unref(n).paddedMonth(p.value)}`,
        `period-${t.displayPeriodUom}`,
        `periodCount-${t.displayPeriodCount}`,
        {
          past: unref(n).isPastMonth(p.value),
          future: unref(n).isFutureMonth(p.value),
          noIntl: !unref(n).supportsIntl
        }
      ])
    }, [
      renderSlot(t.$slots, "header", { headerProps: be.value }),
      createBaseVNode("div", nt, [
        t.displayWeekNumbers ? (openBlock(), createElementBlock("div", st)) : createCommentVNode("", true),
      ...
      createBaseVNode("div", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(fe.value, (i, m) => (openBlock(), createElementBlock("div", {
          key: `${m}-week`,
          class: normalizeClass(["cv-week", `week${m + 1}`, `ws${unref(n).isoYearMonthDay(i)}`])
        }, [
          t.displayWeekNumbers ? (openBlock(), createElementBlock("div", it, [
            renderSlot(t.$slots, "week-number", {
              date: i,
              numberInYear: f.value + m,
              numberInPeriod: m + 1
            }, () => [
              createBaseVNode("span", null, toDisplayString(f.value + m), 1)
            ])
          ])) : createCommentVNode("", true),
          createBaseVNode("div", lt, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(unref(n).daysOfWeek(i), (s, l) => (openBlock(), createElementBlock("div", {
              key: $(l),
              draggable: t.enableDateSelection,
              class: normalizeClass([
                "cv-day",
                $(l),
                `d${unref(n).isoYearMonthDay(s)}`,
                `d${unref(n).isoMonthDay(s)}`,
                `d${unref(n).paddedDay(s)}`,
                `instance${unref(n).instanceOfMonth(s)}`,
                {
                  today: unref(n).isSameDate(s, unref(n).today()),
                  outsideOfMonth: !unref(n).isSameMonth(s, I.value),
                  past: unref(n).isInPast(s),
                  future: unref(n).isInFuture(s),
                  last: unref(n).isLastDayOfMonth(s),
                  lastInstance: unref(n).isLastInstanceOfMonth(s),
                  hasItems: Le(s),
                  selectionStart: unref(n).isSameDate(s, t.selectionStart),
                  selectionEnd: unref(n).isSameDate(s, t.selectionEnd)
                },
                ...t.dateClasses && t.dateClasses[unref(n).isoYearMonthDay(s)] || []
              ]),
              ...
              onDrop: withModifiers((v) => Oe(s, v), ["prevent"]),
              onDragover: withModifiers((v) => ke(s, v), ["prevent"]),
              onDragenter: withModifiers((v) => Ie(s, v), ["prevent"]),
              onDragleave: withModifiers((v) => Ce(s, v), ["prevent"])
            }, [
              createBaseVNode("div", ut, toDisplayString(s.getDate()), 1),
              renderSlot(t.$slots, "day-content", { day: s })
            ], 42, dt))), 128)),
            a.enableHtmlTitles ? (openBlock(true), createElementBlock(Fragment, { key: 0 }, renderList(re(i), (s) => renderSlot(t.$slots, "item", {
              value: s,
              weekStartDate: i,
              top: B(s)
            }, () => [
              (openBlock(), createElementBlock("div", {
                ...
                class: normalizeClass([s.classes, "cv-item"]),
                title: s.tooltip || s.title,
                style: normalizeStyle(`top:${B(s)};${s.originalItem.style}`),
                onDragstart: (l) => ee(s, l),
                onMouseenter: (l) => x(s, l),
                onMouseleave: (l) => _(s, l),
                onClick: withModifiers((l) => Z(s, l), ["stop"]),
                innerHTML: ne(s)
              }, null, 46, ct))
            ])), 256)) : (openBlock(true), createElementBlock(Fragment, { key: 1 }, renderList(re(i), (s) => renderSlot(t.$slots, "item", {
              value: s,
              weekStartDate: i,
              top: B(s)
            }, () => [
...
var mt = { class: "cv-header" };
var ft = { class: "cv-header-nav" };
var Dt = ["disabled"];
var pt = ["disabled", "innerHTML"];
var vt = ["disabled"];
var ht = ["disabled"];
var bt = { class: "periodLabel" };
var kt = defineComponent({
  ...
  setup(e, { emit: r }) {
    ...
    return (u, c) => (openBlock(), createElementBlock("div", mt, [
      createBaseVNode("div", ft, [
        ...
        }, toDisplayString(e.previousYearLabel), 9, Dt),
        createBaseVNode("button", {
